...
def Compare_Country_Cols(df, df_euro_list):
	...
	return (df_cb_curr_dom, df_cb_dom_dom, df_cb_curr_nat, df_cb_dom_nat)

def Filter_CB_and_SSA(df_cb_curr_dom, df_cb_dom_dom, df_cb_curr_nat, df_cb_dom_nat, 
	...
	return df_domicile_corp, df_domicile_ssa, df_nation_corp, df_nation_ssa
...
if __name__ == '__main__':
	...
	df_cb_curr_dom, df_cb_dom_dom, df_cb_curr_nat, df_cb_dom_nat = \
		Compare_Country_Cols(df, df_euro_list)

	# separating cross-border by ssa and corporate
	df_domicile_corp, df_domicile_ssa, df_nation_corp, df_nation_ssa = \
		Filter_CB_and_SSA(df_cb_curr_dom, df_cb_dom_dom, df_cb_curr_nat, df_cb_dom_nat, 
					outfile_dom, outfile_nation)
